    ...
    <v-container style="margin-top: 60px; margin-bottom: 150px">
      <v-row align="center" justify="center">
        ...
        <v-col class="md-12">
          ...
          <v-divider></v-divider>
          <subtitle-1
            >ini penjeleasan product Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Blanditiis laudantium quis soluta dolor id tempore
            consequatur natus dolorum? At modi necessitatibus nemo tempore
            architecto, earum ab qui officia in ut?</subtitle-1
          >
          <v-spacer></v-spacer>
          <br />

          <h3 class="red--text">Rp. 500.0000</h3>
          <br />
          <v-row class="md-6"
